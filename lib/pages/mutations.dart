...
class MutationsPage extends StatefulWidget {
  const MutationsPage({super.key});

  @override
  State<MutationsPage> createState() => _MutationsPageState();
}

class _MutationsPageState extends State<MutationsPage> {
                              ...
                              child: ConstrainedBox(
                                ...
                                child: DataTable(
                                  ...
                                  rows: mutationList.map((mutation) {
                                    final isKeluar = mutation.jenisMutasi == 'Keluar Wilayah';
                                    return DataRow(
                                      cells: [
                                        ...
                                        DataCell(
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: isKeluar ? Colors.red.shade100 : Colors.green.shade100,
