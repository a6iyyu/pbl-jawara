                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text("Judul Pesan", style: TextStyle(fontWeight: FontWeight.w600)),
                          ...
                          const Text("Deskripsi Pesan", style: TextStyle(fontWeight: FontWeight.w600)),
                          const SizedBox(height: 8),
                          TextFormField(
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Pesan ID ${widget.message.id} berhasil diperbarui! Judul: ${_titleController.text}'),
                                ),
                              );
